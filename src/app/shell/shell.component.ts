...
export class ShellComponent {
  ...
  public routesPermissions = {
    admin: [
      ...
      { title: 'Repartidores', link: '/deliverers', icon: 'bicycle-outline', src: 'assets/icons/motocicleta.svg' },
      ...
      { title: 'Todas las órdenes', link: '/finished-orders', icon: 'receipt-outline' },
      { title: 'Crear órden', link: '/create-order', icon: 'add-circle-outline' },

...
@Component({
  ...
  templateUrl: './yeyby-users.component.html',
  styleUrls: ['./yeyby-users.component.scss'],
})
export class YeybyUsersComponent implements OnInit {
  public skeleton: any[] = ['', '', '', '', '', ''];
  ...
  async presentPopover(ev: any, item: any) {
    const popover = await this.popoverController.create({
      component: OptionsYeybyUsersComponent,
      event: ev,
      translucent: true,
  ...
  async sortBy(ev: any) {
    const popover = await this.popoverController.create({
      component: SortByYeybyUserComponent,
      event: ev,
      translucent: true,
    });
